    ...
    <div className="w-[100vw] h-[100vh] overflow-hidden">
      <div className="w-[100vw] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] h-[100vh] overflow-x-hidden overflow-y-hidden bg-white/40 dark:bg-black">
        <Spotlight
          ...
          fill="skyblue"
        />
        <SignupCursorBorderGlowCard className="max-w-md w-full mx-auto max-h-[78%] rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white/20 dark:bg-black/40 mt-32 ">
