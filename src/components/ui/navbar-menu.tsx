          ...
          {active === item && children && (
            <div className="absolute top-[calc(100%_+_1.2rem)]  left-[35%] md:flex-row flex flex-wrap  transform -translate-x-1/2 pt-4 max-w-[90vw] max-h-[600px] ">
              <motion.div
                ...
                className="bg-black flex flex-wrap md:overflow-hidden overflow-y-scroll   rounded-2xl overflow-hidden border border-black/[0.2] dark:border-white/[0.2] shadow-xl"
              >
                <motion.div
                  layout // layout ensures smooth animation
                  className="w-max h-full p-2 backdrop-blur-2xl "
                >
                  {children}
                </motion.div>
              </motion.div>
