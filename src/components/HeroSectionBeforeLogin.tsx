...
const HeroSectionBeforeLogin = () => {
  return (
    <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 min-h-[85%] bg-black/[0.96] bg-dot-white/[0.1] ">
      <Spotlight
