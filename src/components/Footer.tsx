    ...
    <footer className="bg-black text-gray-400 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="mb-4">
            Empowering individuals to enhance their skills and learn from
            top-tier instructors for free on YouTube
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="space-x-4 flex items-start">
            <a className="social-link1 cursor-pointer" href="https://www.instagram.com/master_utsav" target="_blank" >
            ...
            <a className="social-link2 cursor-pointer" href="https://github.com/Master-utsav" target="_blank">
            <Tooltip text="Github">
              <svg
                viewBox="0 0 496 512"
                width="32px"
            ...
            <a className="social-link3 cursor-pointer" href="https://discord.com" target="_blank">
            ...
            <a className="social-link4 cursor-pointer" href="https://www.linkedin.com/in/master-utsav" target="_blank">
